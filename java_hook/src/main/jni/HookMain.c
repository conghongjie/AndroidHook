...
void Java_com_elvis_android_hook_java_JavaHook_init(JNIEnv *env, jclass clazz, jint sdkVersion) {
    int i;
...
void Java_com_elvis_android_hook_java_JavaHook_findAndBackupAndHook(JNIEnv *env, jclass clazz,
